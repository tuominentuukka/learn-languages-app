...
/**
 * @class LearningPageFinnish
 * Represents a LearningPageFinnish.
 * <br>class to build learningPage component
 * @extends React.Component
 */
class LearningPageFinnish extends React.Component {
  /**
      ...
      <Box className="content">
        ...
        >
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
            <TableHead>
              <TableRow>
                <StyledTableCell align="right">Englanniksi</StyledTableCell>
                <StyledTableCell>Suomeksi</StyledTableCell>
              </TableRow>
            </TableHead>
            <TableBody>
...
export default LearningPageFinnish;
